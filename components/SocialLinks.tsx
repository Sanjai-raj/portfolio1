  ...
  return (
    <>
      {page === "index" ? (
        ...
        <div className="hidden fixed left-10 bottom-0 md:flex flex-col w-6 h-60 items-center justify-between">
          <div className="-rotate-90 text-lg tracking-widest">
            <a
              href="mailto:sanjaisundharraj@gmail.com"
              className="link-outline hover:text-marrsgreen dark:hover:text-carrigreen"
            >
              sanjaisundharraj@gmail.com
            </a>
          </div>
          <div className="w-40 h-1 bg-bgdark dark:bg-bglight rotate-90"></div>
        </div>
      )}
      <div className="hidden fixed right-10 bottom-16 md:flex flex-col w-6 h-[13rem] items-center justify-between">
...
const socialLinks = [
  {
    id: 1,
    title: "Sanjai's Github Profile",
    link: "https://github.com/Sanjai-raj",
    svg: (
      <svg
  ...
  {
    id: 2,
    title: "Sanjai's LinkedIn Profile",
    link: "https://www.linkedin.com/in/sanjairaj7/",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
